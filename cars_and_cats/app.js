...
var server = http.createServer(function(request, response) {
  ...
  if (request.url === "/lowriders") {
    ...
    fs.readFile("./stylesheets/style002.css", "utf8", function(errors, contents) {
      response.writeHead(200, { "Content-type": "text/css" });
      response.write(contents);
      response.end();
    });
    ...
    fs.readFile("./stylesheets/style003.css", "utf8", function(errors, contents) {
      response.writeHead(200, { "Content-type": "text/css" });
      response.write(contents);
      response.end();
    });
